...
$sql = "UPDATE `shop` SET `takeNum` = `takeNum` + 1 WHERE `shop_id` = 2";
$result=mysqli_query($conn,$sql);
$sql = "SELECT * FROM `shop` WHERE `shop_id` = 2 ORDER BY `shop`.`shop_id` ASC LIMIT 0, 30 ";
$result=mysqli_query($conn,$sql);
...
<body>
    ...
    <H2>SUBWAY 高師大店</H2>
    <P>
        地址<br>高雄市苓雅區和平一路116號學生活動中心1F<br>連絡電話<br>07 727 9881
    </P>
    <H1>預約結果</H1>
    <?php
