...
$sql = "UPDATE `shop` SET `takeNum` = `takeNum` + 1 WHERE `shop_id` = 3";
$result=mysqli_query($conn,$sql);
$sql = "SELECT * FROM `shop` WHERE `shop_id` = 3 ORDER BY `shop`.`shop_id` ASC LIMIT 0, 30 ";
$result=mysqli_query($conn,$sql);
...
<body>
    ...
    <H2>多那之高雄文化門市</H2>
    <P>
        地址<br>高雄市苓雅區和平一路149-15號<br>連絡電話<br>07 716 2878
    </P>
    <H1>預約結果</H1>
    <?php
