...
$sql = "UPDATE `shop` SET `takeNum` = `takeNum` + 1 WHERE `shop_id` = 6";
$result=mysqli_query($conn,$sql);
$sql = "SELECT * FROM `shop` WHERE `shop_id` = 6 ORDER BY `shop`.`shop_id` ASC LIMIT 0, 30 ";
$result=mysqli_query($conn,$sql);
...
<body>
    ...
    <H2>橘葉 壽司、丼飯專門店</H2>
    <P>
        地址<br>高雄市苓雅區林泉街65號<br>連絡電話<br>07 722 1812
    </P>
    <H1>預約結果</H1>
    <?php
