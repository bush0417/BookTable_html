...
$sql = "UPDATE `shop` SET `takeNum` = `takeNum` + 1 WHERE `shop_id` = 7";
$result=mysqli_query($conn,$sql);
$sql = "SELECT * FROM `shop` WHERE `shop_id` = 7 ORDER BY `shop`.`shop_id` ASC LIMIT 0, 30 ";
$result=mysqli_query($conn,$sql);
...
<body>
    ...
    <H2>首爾韓國食堂</H2>
    <P>
        地址<br>高雄市苓雅區林泉街27號<br>連絡電話<br>07 716 2179
    </P>
    <H1>預約結果</H1>
    <?php
