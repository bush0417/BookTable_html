...
$sql = "UPDATE `shop` SET `takeNum` = `takeNum` + 1 WHERE `shop_id` = 8";
$result=mysqli_query($conn,$sql);
$sql = "SELECT * FROM `shop` WHERE `shop_id` = 8 ORDER BY `shop`.`shop_id` ASC LIMIT 0, 30 ";
$result=mysqli_query($conn,$sql);
...
<body>
    ...
    <H2>日日和食</H2>
    <P>
        地址<br>高雄市苓雅區林泉街10號<br>連絡電話<br>0958 305 126
    </P>
    <H1>預約結果</H1>
    <?php
