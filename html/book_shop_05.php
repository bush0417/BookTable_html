...
$sql = "UPDATE `shop` SET `takeNum` = `takeNum` + 1 WHERE `shop_id` = 5";
$result=mysqli_query($conn,$sql);
$sql = "SELECT * FROM `shop` WHERE `shop_id` = 5 ORDER BY `shop`.`shop_id` ASC LIMIT 0, 30 ";
$result=mysqli_query($conn,$sql);
...
<body>
    ...
    <H2>青木堂-苓雅店</H2>
    <P>
        地址<br>高雄市苓雅區林泉街77號<br>連絡電話<br>07 726 1600
    </P>
    <H1>預約結果</H1>
    <?php
